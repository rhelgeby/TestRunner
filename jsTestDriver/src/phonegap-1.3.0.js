...
console.log("typeof PhoneGap: " + typeof PhoneGap);

if (typeof PhoneGap === "undefined") {

console.log("Constructing PhoneGap...");
...
PhoneGap.addConstructor = function(func) {
    PhoneGap.onPhoneGapInit.subscribeOnce(function() {
        try {
            func();
            console.log("PhoneGap - running constructor.");
        } catch(e) {
...
PhoneGap.initializationComplete = function(feature) {
    console.log("Feature ready: " + feature);
...
console.log("PhoneGap - line 2244");

/**
 * Add the contact interface into the browser.
 */
PhoneGap.addConstructor(function() {
    console.log("Contacts constructing...");
